...
namespace GeekShopping.OrderAPI.MessageConsumer
{
    public class RabbitMQPaymentConsumer : BackgroundService
    {
        ...
        public RabbitMQPaymentConsumer(OrderRepository repository)
        {
            ...
            _channel.QueueDeclare(PaymentOrderUpdateQeueName, false, false, false, null);
            _channel.QueueBind(PaymentOrderUpdateQeueName, ExchangeName, "PaymentOrder");
        }
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            _channel.BasicConsume(PaymentOrderUpdateQeueName, false, consumer);
